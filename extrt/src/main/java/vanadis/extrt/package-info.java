 ...
 *
 * <P>This bundle is that extender.  It launches by having its {@link net.sf.vanadis.ext.BundleActivator
 * bundle activator} launch a {@link net.sf.vanadis.ext.FrameworkTracker framework tracker}.
 * It listens for bundles, and then pokes around in them for the
 * {@link net.sf.vanadis.ext.Module} annotation.  Once
 * found, it will register {@link net.sf.vanadis.ext.ObjectManagerFactory object manager factories}
 * for each module {@link net.sf.vanadis.ext.Module#moduleType() type}.
 */
