...
import net.sf.vanadis.lang.piji.ExprRunnable;
import net.sf.vanadis.lang.piji.Expression;

@EntryPoint("Reflection")
public final class ThreadFunction extends AbstractFunction {

    @EntryPoint("Reflection")
    public ThreadFunction(Context ctx) {
        super("Creates, starts and returns thread: <expression>*",
              true, 1, ctx);
    }
    ...
    public Object apply(Context context, Expression[] args)
        ...
        ExprRunnable er = new ExprRunnable(context, args);
        new Thread(er).start();
        return er;
    }
