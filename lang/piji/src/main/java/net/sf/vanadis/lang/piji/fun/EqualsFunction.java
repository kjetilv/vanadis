...
public class EqualsFunction extends AbstractCompareFunction {

    @EntryPoint("Reflection")
    public EqualsFunction(Context ctx) {
        this("Object.equals() equality", ctx);
    }

    public EqualsFunction(String doc, Context ctx) {
        super(doc, ctx);
    }
