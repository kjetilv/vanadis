...
public class VanadisLauncher implements OSGiLauncher {
    ...
    public VanadisLauncher(BundleContext bundleContext) {
    ...
    private static final Logger log = LoggerFactory.getLogger(VanadisLauncher.class);
